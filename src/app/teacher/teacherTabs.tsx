...
export function TeacherTabs() {
  ...
  return (
    <div className="relative mx-auto flex w-64 gap-2 rounded-full bg-slate-100 p-1.5 ring-1 ring-slate-200">
      <div
      ...
      {tabs.map((tab) => (
        <LangLink
          key={tab.href}
          href={tab.href}
          className="relative z-10 flex-1 rounded-full px-4 py-1.5 text-center text-sm font-semibold text-slate-700 transition duration-300 hover:bg-slate-200/60"
        >
