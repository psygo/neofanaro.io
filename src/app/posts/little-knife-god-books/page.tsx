...
const postPath = "little-knife-god-books"
          ...
          <Post data={post}>
            <PostSection>
              <PostParagraph>
                ...
                Vieira 4d EGF, introduced me to a
                little-known &mdash; in the West &mdash;
                Taiwanese Go books author,{" "}
              ...
              <PostParagraph>
                Most of his books are based on key moments
                in professional games, which makes it very
                likely even readers of the highest ranks
                will be able to enjoy them.
              </PostParagraph>
              <PostParagraph>
                Despite not knowing any Chinese, I find it
                quite ok to follow the diagrams, as what the
                author would like to convey feels more or
                less self-evident.
              </PostParagraph>
              <PostParagraph>
                So far, I only own his sabaki book.
                Here&apos;s an example from a professional
                game between{" "}
                <PostLink href="https://kifudepot.net/kifucontents.php?id=s%2FfzvBdQObbE93Xj6SuZYg%3D%3D">
                  Kato Chie 3p (White) and Yoshihiro Koike
                  7p (Black)
                </PostLink>
              ...
              <PostParagraph>
                ...
                shape will get fixed on the outside, and the
                cut at 4 will likely be triggered:
              </PostParagraph>
              <GoDiagram
              ...
              />
              <PostParagraph>
                As a hint, the correct move is very similar
                to the solution to{" "}
              ...
              <PostParagraph>
                ...
                pressure based on Black&apos;s cutting stone
                in the center. By doing so, we can create
                cutting many cutting points on White&apos;s
                shape:
              </PostParagraph>
              <GoDiagram
              ...
              />
              <PostParagraph>
                If White goes for a capturing race, Black is
                the one ahead actually.
              </PostParagraph>
              <GoDiagram
              ...
              <PostParagraph>
                ...
                available on Taobao, but I suggest
                contacting him through Facebook for more
                details, since he seems friendly and active
                on social media.
              </PostParagraph>
              <PostParagraph>
                He also seems to have an amusing taste for
                creating covers with AI. Personally, I find
                those quite funny and playful, especially
                for children, which are one of his main
                targets, since most of his in-person
                students seem to be of that age.
              </PostParagraph>
              <Image
